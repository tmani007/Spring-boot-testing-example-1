...
public class EmployeeControllerITests {
    ...
    // Integration test for GetEmployeeById REST API - Positive Case-Valid employee id
    @Test
    ...
    // Integration test for GetEmployeeById REST API - Negative Case-InValid employee id
    @Test
    ...
    // Integration test for Update Employee REST API - positive Case
    @Test
